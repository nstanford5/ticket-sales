...
class Player extends React.Component {
    ...
    // these are from RPS and need to be converted to Morra
    ...
    //actualTotal(sum) { this.setState({view: 'SeeActual', actual: sum}); }
    seeOutcome(i) { this.setState({view: 'Done', outcome: intToOutcome[i]});}
    informTimeout() {this.setState({view: 'Timeout'}); }
    playHand(hand) { this.state.resolveHandP(hand); }
    playGuess(guess) { this.state.resolveGuessP(guess); }
    //actualTotal(sum) { this.setState({view: 'Total', seeActual: sum}); }
}
