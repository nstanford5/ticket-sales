...
contract('myERC', () => {
  ...
  it('should mint, return balance, check tokenId for owner', async () => {
    ...
    try {
      await storage.safeMint('0x0000000000000000000000000000000000000000', 0);
    } catch (e) {
      console.log(`Mint test failed successfully: ${e}`);
    }

    await storage.safeMint('0x1028c139157ab9be0eb649c6fc10fb792b21cb67', 0);
  ...
  it('should mint a collection', async () => {
    ...
    for(let i = 0; i < 10; i++){
      await storage.safeMint(addresses[i], i);
  ...
  it('should transfer NFT', async () => {
    ...
    await storage.safeMint('0x75b8304824832f0d997345bdc717103d9a2fb99b', 0);
  ...
  it('should mint a collection to a single owner', async () => {
    ...
    for(let i = 0; i < 50; i++){
      await storage.safeMint('0x75b8304824832f0d997345bdc717103d9a2fb99b', i);
    }
  ...
  it('should approve non-owners', async () => {
    ...
    await storage.setApprovalForAll('0xc28569362a51520be4817db263d180ecf4973c24', true);

    const b = await storage.isApprovedForAll('0x75b8304824832f0d997345bdc717103d9a2fb99b', '0xc28569362a51520be4817db263d180ecf4973c24');
    console.log(`Approval is: ${b}`);
  })
})
